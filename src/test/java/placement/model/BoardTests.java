...
public class BoardTests {
    ...
    public void givenEmptyBoard_WhenPLacingTwoShipsFarApart_ThenEverythingOK() {
        ...
        Ship ship1 = new Ship(1, Direction.NORTH);
    ...
    public void givenEmptyBoard_WhenPLacingTwoShipsNextToEachOther_ThenEverythingOK() {
        ...
        Ship ship1 = new Ship(3, Direction.EAST);
        Ship ship2 = new Ship(2, Direction.SOUTH);

        board.placeShip(ship2, 3, 7);
        board.placeShip(ship1, 3, 5);
    ...
    public void givenEmptyBoard_WhenPlacingThreeShipsOnTheBoardEdge_ThenEverythingOK() {
        ...
        Ship ship1 = new Ship(3, Direction.EAST);
        Ship ship2 = new Ship(2, Direction.SOUTH);
        Ship ship3 = new Ship(4, Direction.NORTH);

        board.placeShip(ship1, 3, 9);
        board.placeShip(ship2, 0, 7);
        board.placeShip(ship3, 9, 9);
    ...
    public void board_shipPlacedOnOtherShip_ShipIsNotPlaced() {
        ...
        Ship firstShip = new Ship(3, Direction.EAST);
        Ship shipPlacedOnFirstShip = new Ship(3, Direction.SOUTH);
        board.placeShip(firstShip, 1, 1);
