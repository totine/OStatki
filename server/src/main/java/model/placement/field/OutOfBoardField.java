...
public class OutOfBoardField implements Field {
    ...
    /**
     * @return return parameter is of FieldState and always is OUT_OF_BOUND which
     ...
     *
     * @return empty character which indicates that this field is beyond the board.
     */
    @Override
    ...
    /**
     * @return always false as on OUT_OF_BOUND type field player cannot place anything.
     */
    @Override
